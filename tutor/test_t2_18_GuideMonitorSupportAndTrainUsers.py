...
TESTS = os.getenv(
    'CASELIST',
    str([14752, 14751, 58279, 58280, 58284, 58352, 58288, 58313, 58314, 58315,
         58322, 58316, 58318, 58319, 14755, 14750, 58336, 58337, 58338, 58353,
         58339, 58340, 58341, 58342, 58343, 58344, 58346, 58347, 58348])  # NOQA
)
...
class TestGuideMonitorSupportAndTrainUsers(unittest.TestCase):
    ...
    @pytest.mark.skipif(str(14752) not in TESTS, reason='Excluded')  # NOQA
    ...
    # courses yet
    @pytest.mark.skipif(str(14751) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58279) not in TESTS, reason='Excluded')  # NOQA
    ...
    # a course
    @pytest.mark.skipif(str(58280) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58284) not in TESTS, reason='Excluded')  # NOQA
    ...
    # question
    @pytest.mark.skipif(str(58352) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58288) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58313) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58314) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58315) not in TESTS, reason='Excluded')  # NOQA
    ...
    # article
    @pytest.mark.skipif(str(58322) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58316) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58318) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58319) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(14755) not in TESTS, reason='Excluded')  # NOQA
    ...
    # courses yet
    @pytest.mark.skipif(str(14750) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58336) not in TESTS, reason='Excluded')  # NOQA
    ...
    # course
    @pytest.mark.skipif(str(58337) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58338) not in TESTS, reason='Excluded')  # NOQA
    ...
    # question
    @pytest.mark.skipif(str(58353) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58339) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58340) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58341) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58342) not in TESTS, reason='Excluded')  # NOQA
    ...
    # article
    @pytest.mark.skipif(str(58343) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58344) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58346) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58347) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(58348) not in TESTS, reason='Excluded')  # NOQA
