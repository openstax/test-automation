...
from staxing.helper import Teacher, Student, User  # NOQA
...
TESTS = os.getenv(
    'CASELIST',
    str([14820, 14819, 14759, 14862, 14771, 14821, 14822])  # NOQA
)
...
class TestImproveLoginRegistrationEnrollment(unittest.TestCase):
    ...
    @pytest.mark.skipif(str(14820) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(14819) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(14759) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(14862) not in TESTS, reason='Excluded')  # NOQA
    ...
    # before signing up
    @pytest.mark.skipif(str(14771) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(14821) not in TESTS, reason='Excluded')  # NOQA
    ...
    @pytest.mark.skipif(str(14822) not in TESTS, reason='Excluded')  # NOQA
