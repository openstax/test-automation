...
class TestAccountMaintenance(unittest.TestCase):
    ...
    def test_admin_search_for_a_username(self):
        ...
        self.admin.driver.find_element(By.ID,'query').send_keys('Dr Aticus Finch III')
        self.admin.driver.find_element(By.XPATH,'//input[@value="Search"]').click()
        self.admin.driver.find_element(By.XPATH,'//td[text()="Dr Aticus Finch III"]')
        self.ps.test_updates['passed'] = True


    # Case C8248 - 002 - Admin | Search for a user's name
    @pytest.mark.skipif(str(8248) not in TESTS, reason='Excluded')  # NOQA
    def test_admin_search_for_a_users_name(self):
    ...
    def test_admin_create_a_user(self):
        """Create a new user. 
    ...
    def test_admin_edit_a_user(self):
        """Edit a user. 
        ...
        #edit user
        self.admin.wait.until(
            expect.element_to_be_clickable(( By.XPATH,'//a[contains(text(),"Edit")]'))
        ).click()
        self.admin.driver.find_element(
    ...
    def test_admin_assign_elevated_permissions(self):
    ...
    def test_admin_remove_elevated_permissions(self):
    ...
    def test_admin_impersonate_a_user(self):
        """Impersonate a user. 
        ...
        Goes to chosen users initial screen after login (different depending on the user)
        """
        ...
        self.admin.driver.find_element(By.XPATH,'//input[@value="Search"]').click()
        self.admin.wait.until(
            expect.element_to_be_clickable(( By.XPATH,'//a[contains(text(),"Sign in as")]'))
        ).click()
        self.admin.wait.until(
            expect.element_to_be_clickable(
