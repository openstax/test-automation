...
class TestEpicName(unittest.TestCase):
    ...
    # Case C7626 - 002 - Student | Following Concept Coach login author links are not seen
    ...
    # Case C7627 - 003 - Student | Able to use the table of contents to navigate the book without impacting the reading assignment
    @pytest.mark.skipif(str(7627) not in TESTS, reason='Excluded')  # NOQA
    def test_usertype_story_text(self):
        """Able to use the table of contents to navigate the book without impacting the reading assignment.
        ...
        The user is able to navigate the book without impacting the reading assignment
    ...
    def test_usertype_story_text(self):
        ...
        The search word is highlighted in yellow within the text and is bolded within the table of contents
