...
class TestCreateAReading(unittest.TestCase):
    ...
    def test_teacher_create_and_publish_a_new_open_reading_132519(self):
        ...
        Click on the Open Date text field and click on today's date on calendar
        pop-up
    ...
    def test_teacher_save_a_draft_reading_for_individual_sections_132520(self):
        ...
        Steps:
        Click on the Add Assignment sidebar menu on the user dashboard if it is
        not already open
        ...
        calendar pop-up
        - Click on the Due Date text field and click on desired due date in the
        future on calendar pop-up
        Click on the "+ Add Readings" button
        Click on section(s) to add to assignment
        Scroll to bottom of the page
        Click on the "Add Readings" button
    ...
    def test_teacher_create_publish_new_unopened_read_from_cal_132521(self):
        """
    ...
    def test_teacher_cancel_a_new_reading_before_make_any_changes_132523(self):
        """
    ...
    def test_teacher_attempt_save_or_publish_read_w_blank_req_132525(self):
        """
    ...
    def test_teacher_rearrange_reading_sections_132532(self):
        ...
        chapter_sections = self.teacher.find_all(
            By.XPATH,
            '//div[@class="panel-heading"]//div[@data-chapter-section="%s"]' +
    ...
    def test_teacher_add_a_reading_by_dragging_and_dropping_132533(self):
        ...
        calendar_dest = self.teacher.driver.find_element(
            By.XPATH,
            './/*[@id="ox-react-root-container"]' +
            '/div/div/div/div/span/span/div/div[3]' +
            '/div[2]/div[2]/div[2]/div[1]/div[6]/div/div[6]'
        )
        print('Start Action')
        try:
            actions = ActionChains(self.teacher.driver)
            # actions.drag_and_drop(drag_tile, calendar_dest).perform()
            actions.click_and_hold(drag_tile) \
    ...
    def test_teacher_get_assignment_link_and_review_metrics(self):
        ...
        (The teacher is taken to a page that shows problems with answers in
        the assigned reading chapters and students' progress in this reading
        assignment )
