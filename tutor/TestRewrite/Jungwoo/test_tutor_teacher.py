...
class TestTutorTeacher(unittest.TestCase):
    ...
    def test_course_cloning_and_copying_past_assignments_162241(self):
        ...
        ***When user clicks on a past Reading on the left panel, An auto-filled event creation form appeared***
        ...
        self.ps.test_updates['name'] = 'tutor_course_creation_teacher_162241' + \
            inspect.currentframe().f_code.co_name[4:]
        self.ps.test_updates['tags'] = ['tutor', 'course creation', 'teacher', '162241']
    ...
    def test_tutor_help_center_162246(self):
        ...
        ***User is presented with the related article***
        ...
        self.ps.test_updates['name'] = 'tutor_help_center_teacher_162246' \
            + inspect.currentframe().f_code.co_name[4:]
        self.ps.test_updates['tags'] = ['tutor', 'help_center', 'teacher', '162246']
        self.ps.test_updates['passed'] = False
    ...
    def test_no_course_page_and_tutor_guides_162247(self):
        ...
        ***Tutor Help Center opens in another tab with the Getting Started guide***
        ...
        self.ps.test_updates['name'] = 'tutor_help_center_teacher_162247' + \
            inspect.currentframe().f_code.co_name[4:]
        self.ps.test_updates['tags'] = ['tutor', 'help_center', 'teacher', '162247']
        self.ps.test_updates['passed'] = False

        # log in to demo teacher with 0 courses
        self.teacher.login(username=os.getenv('TEACHER_USER_DEMO'),
    ...
    def test_editing_course_settings_162250(self):
        ...
        ***The instructor is removed from the Instructors list***
        ...
        """
        self.ps.test_updates['name'] = 'tutor_course_settings_and_roster_teacher_162250' + \
            inspect.currentframe().f_code.co_name[4:]
        self.ps.test_updates['tags'] = ['tutor', 'course_settings_and_roster', 'teacher', '162250']
        self.ps.test_updates['passed'] = False
        ...
        # click rename period
        self.teacher.find(By.CSS_SELECTOR,'.control.rename-period.btn.btn-link').click()
        # store the current period name
        periodname = self.teacher.find(By.CSS_SELECTOR,'.form-control').get_attribute('value')
        # delete it
        self.teacher.find(By.CSS_SELECTOR,'.form-control').send_keys(Keys.BACKSPACE*10)
        self.teacher.sleep(.5)
        # rename the period as 'renamed'
        self.teacher.find(By.CSS_SELECTOR,'.form-control').send_keys('renamed')
        self.teacher.sleep(.5)
        # confirm renaming
        self.teacher.find(
            By.CSS_SELECTOR,
        ...
        self.teacher.find(By.CSS_SELECTOR,'.control.rename-period.btn.btn-link').click()
        self.teacher.find(By.CSS_SELECTOR,'.form-control').send_keys(Keys.BACKSPACE*10)
        self.teacher.find(By.CSS_SELECTOR,'.form-control').send_keys(periodname)
        self.teacher.find(
            By.CSS_SELECTOR,
            '.async-button.-edit-period-confirm.btn.btn-default').click()
        ...
        self.teacher.find(By.CSS_SELECTOR,'.control.add-teacher.btn.btn-link').click()
        link = self.teacher.find(By.CSS_SELECTOR,'.copy-on-focus').get_attribute('value')
        self.teacher.find(By.CSS_SELECTOR,'.close').click()
        self.teacher.sleep(.5)
        # delete teacher
        self.teacher.find(
            By.XPATH,
            './/*[contains(text(),"Desiree")]/.././/*[@aria-describedby]').click()
        self.teacher.find(By.CSS_SELECTOR,'.async-button.btn.btn-danger').click()
        self.teacher.sleep(40)
        count = 0
        XPATHLINK= './/*[contains(text(),"%s")]' % (COURSETITLE)
        while count < 11 and flag == True:
    ...
    def test_adding_and_deleting_instructors_162251(self):
        ...
        ***The instructor is removed from the Instructors list***
        ...
        """
        self.ps.test_updates['name'] = 'tutor_course_settings_and_roster_teacher_162251' + \
            inspect.currentframe().f_code.co_name[4:]
        self.ps.test_updates['tags'] = ['tutor', 'course_settings_and_roster', 'teacher', '162251']
        self.ps.test_updates['passed'] = False
